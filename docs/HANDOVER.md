...
Non-draft [`Pape45/VineyardMac#6`](https://github.com/Pape45/VineyardMac/pull/6), `Document qualified GPTK 4 beta 2 candidate`, is open from `gptk4-feasibility-audit` to `main`. It is not merged.
